      ...
      <div className="p-5">
        ...
        <div className="space-y-2 mt-4 text-sm text-slate-600 dark:text-slate-400">
          ...
          <div className="flex items-center gap-2">
            ...
            <span>{isRutin ? `Setiap ${acf.hari_kajian}` : acf.tanggal_kajian}</span>
          </div>
          <div className="flex items-center gap-2">
            <Clock className="w-4 h-4 text-slate-400" />
            <span>{acf.jam_mulai} - {acf.jam_selesai || 'Selesai'} ({acf.waktu_keterangan})</span>
          </div>
          <div className="flex items-center gap-2">
